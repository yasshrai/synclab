    ...
    <div className="min-h-screen flex flex-col bg-slate-200 dark:bg-zinc-950">
      <header className="w-full px-4 py-6 bg-slate-200 dark:bg-zinc-950">
        <div className="container mx-auto flex items-center justify-between lg:justify-evenly">
          <Link
            href="/"
            className="text-3xl font-bold text-slate-800 dark:text-slate-100 hover:opacity-80 transition-opacity"
            prefetch={false}
          >
            SyncLab
          </Link>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ...
                >
                  <Card className="h-full bg-slate-200 dark:bg-zinc-950 border-slate-200 dark:border-zinc-700">
                    <CardHeader>
